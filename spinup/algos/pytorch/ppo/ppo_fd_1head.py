...
def ppo(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
        ...
        fd_kwargs=dict(), fd_scaling_factor=20000, fd_lr=1e-3, train_fd_iters=80, only_intr=False):
    """
    ...
    for epoch in range(epochs):
            ...
            if terminal or epoch_ended:
                ...
                if terminal:
                    ...
                    logger.store(EpRet=ep_ret, EpLen=ep_len,
                                 EpIntrRet=ep_intr_ret, EpExtrRet=ep_extr_ret)
                o, ep_ret, ep_len = env.reset(), 0, 0
                ep_intr_ret, ep_extr_ret = 0, 0
        # Save model
        ...
        logger.log_tabular("EpExtrRet", with_min_and_max=True)
        logger.dump_tabular()
...
if __name__ == '__main__':
    ...
    # Motivation Type
    parser.add_argument('--only_intr', action='store_true')
    ...
    ppo(lambda: gym.make(args.env), actor_critic=core.MLPActorCritic,
        ...
        fd_kwargs=dict(hidden_sizes=[args.fd_hid]*args.fd_l), only_intr=args.only_intr)
